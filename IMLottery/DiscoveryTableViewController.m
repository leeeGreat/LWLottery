...
@property (weak, nonatomic) IBOutlet IMNavButtonBarItem *TitleBtnItem;
@property (nonatomic, assign, getter=isRotated) BOOL Rotated;

- (IBAction)DidClickedTitleItem;
...
- (IBAction)DidClickedTitleItem {
    ...
    if (self.Rotated) {
        self.TitleBtnItem.imageView.transform = CGAffineTransformMakeRotation(M_PI);
    }else{
        self.TitleBtnItem.imageView.transform = CGAffineTransformMakeRotation(0);
    }
    
}

-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    NSLog(@"fjdasklfjdas;klj");
}
